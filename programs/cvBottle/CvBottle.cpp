...
/************************************************************************/
bool CvBottle::configure(ResourceFinder &rf) {
    ...
    printf("CvBottle using cropSelector: %d.\n",cropSelector);
    ...
    printf("CvBottle using kinectDevice: %s, kinectLocal: %s, kinectRemote: %s.\n",
        strKinectDevice.c_str(), strKinectLocal.c_str(), strKinectRemote.c_str());
    printf("CvBottle using watchdog: %f.\n",watchdog);
...
/*****************************************************************/
double CvBottle::getPeriod() {
    return watchdog;  // [s]
}

/************************************************************************/

bool CvBottle::updateModule() {
    printf("CvBottle alive...\n");
    return true;
}

/************************************************************************/

bool CvBottle::interruptModule() {
    printf("CvBottle closing...\n");
